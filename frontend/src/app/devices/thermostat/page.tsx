...
const Thermostat = () => {
        ...
        const handleDeviceFetch = async () => {
            try {
                ...
                if (response.data.data) {
                    const filteredDevices: any = response.data.data.filter(
    ...
    const cardData: IDeviceCard[] = [
        {
            description: 'Cool thermostat',
            actionType: ActionType.PRIMARY,
            id: '4141sfsf',
            title: 'Samsung thermostat',
        },
        {
            description: 'Cool thermostat',
            actionType: ActionType.SECONDARY,
            id: 'dsghg',
            title: 'Huawei thermostat',
        },
        {
            description: 'Cool thermostat',
            disable: true,
    ...
    return (
        <Layout>
            <AuthRestriction auth>
                ...
                >
                    <div>Connected thermostat device</div>
